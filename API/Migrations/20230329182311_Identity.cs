    ...
    public partial class Identity : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PetitionReplies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PetitionReplies_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PetitionReplies_Petitions_PetitionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PetitionReplies_PetitionId",
                table: "PetitionReplies",
                column: "PetitionId");

            migrationBuilder.CreateIndex(
                name: "IX_PetitionReplies_UserId",
                table: "PetitionReplies",
                column: "UserId");
